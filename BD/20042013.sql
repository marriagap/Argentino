...
CREATE TABLE `persona` (
  ...
  `segundoNombre` varchar(45) DEFAULT NULL COMMENT 'Apellido para una persona natural, razonSocial cuando sea una persona juridica',
...
CREATE TABLE `movimiento` (
  ...
  `codOfertas` int(11) DEFAULT NULL,
...
-- Dump completed on 2013-04-20  7:33:24
